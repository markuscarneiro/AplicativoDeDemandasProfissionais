@echo off
echo ======================================================
echo    🚀 INICIANDO SERVIDOR DJANGO - PORTA 8080
echo ======================================================
echo.
echo 🎯 Porta Alternativa: Esta porta geralmente está 
echo    liberada em ambientes corporativos!
echo.
...
echo ======================================================
echo    🎯 INFORMAÇÕES DE ACESSO - PORTA 8080
echo ======================================================
echo.
echo 🖥️  ACESSO LOCAL:
...
echo    • Porta 8080 geralmente JÁ está liberada!
echo    • IP pode mudar se DHCP estiver ativo
echo.
echo 🔥 Se necessário, liberar porta no Firewall (como Admin):
echo    netsh advfirewall firewall add rule name="Django Server Port 8080" dir=in action=allow protocol=TCP localport=8080
echo.
echo ======================================================
...
REM Iniciar servidor Django na porta 8080
echo 🌟 Servidor iniciando em 0.0.0.0:8080...
